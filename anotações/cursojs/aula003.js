...
/*
    ...
    template literals permitem textos multilinhas e expressões de linguagem com os 
    caracteres ${ }, por exemplo: console.log(A soma de duas unidades é ${1+1}), 
    já as outras não, por exemplo: console.log("Isso é um texto").
*/


console.log("ele disse 'ola' então..")
console.log('ele disse "ola" então...')
console.log(`Eu tenho ${12 + 4} anos`)